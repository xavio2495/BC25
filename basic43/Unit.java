...
public abstract class Unit extends MyRobot {
    ...
    void tryGivePaint() throws GameActionException {
        boolean lategame =   rc.getRoundNum() > Constants.MIN_ROUNDS_NO_RECOVERY && rc.getNumberTowers() > Constants.MIN_TOWERS_NO_RECOVERY;
        ...
        for (RobotInfo r : rs){
            if (lategame && r.getType() == UnitType.SOLDIER) continue;
            if (isHurt(r)){
