...
public abstract class Unit extends MyRobot {
    ...
    static MapLocation getRecoveryLoc() throws GameActionException {
        ...
        if(tower == null){
            TowerManager.closestPaintTower = null;
    ...
    static void removeMarks() throws GameActionException {
        MapLocation myLoc = rc.getLocation();
        MapLocation loc = myLoc;
        if (rc.canSenseLocation(loc) && rc.senseMapInfo(loc).getMark() == PaintType.ALLY_SECONDARY) tryRemoveMark(loc);
