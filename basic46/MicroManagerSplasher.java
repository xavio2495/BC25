...
public class MicroManagerSplasher {
    ...
    static boolean doMicro() throws GameActionException {
        ...
        if (microInfos[0].isAccessible && (microInfos[0].moppersInRange > 0 || (canAttack && microInfos[0].atkLoc != null))) shouldMicro = true;
        if (microInfos[1].isAccessible && (microInfos[1].moppersInRange > 0 || (canAttack && microInfos[1].atkLoc != null))) shouldMicro = true;
        if (microInfos[2].isAccessible && (microInfos[2].moppersInRange > 0 || (canAttack && microInfos[2].atkLoc != null))) shouldMicro = true;
        if (microInfos[3].isAccessible && (microInfos[3].moppersInRange > 0 || (canAttack && microInfos[3].atkLoc != null))) shouldMicro = true;
        if (microInfos[4].isAccessible && (microInfos[4].moppersInRange > 0 || (canAttack && microInfos[4].atkLoc != null))) shouldMicro = true;
        if (microInfos[5].isAccessible && (microInfos[5].moppersInRange > 0 || (canAttack && microInfos[5].atkLoc != null))) shouldMicro = true;
        if (microInfos[6].isAccessible && (microInfos[6].moppersInRange > 0 || (canAttack && microInfos[6].atkLoc != null))) shouldMicro = true;
        if (microInfos[7].isAccessible && (microInfos[7].moppersInRange > 0 || (canAttack && microInfos[7].atkLoc != null))) shouldMicro = true;
        if (microInfos[8].isAccessible && (microInfos[8].moppersInRange > 0 || (canAttack && microInfos[8].atkLoc != null))) shouldMicro = true;
