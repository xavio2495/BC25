...
public class Util {
    ...
    static boolean noHealSoldiers(){
        return (MyRobot.rc.getRoundNum() > Constants.MIN_ROUNDS_NO_RECOVERY && MyRobot.rc.getNumberTowers() > Constants.MIN_TOWERS_NO_RECOVERY);
    }
