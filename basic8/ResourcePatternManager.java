...
public class ResourcePatternManager {
    ...
    static MapLocation process0() throws GameActionException { // (0,0)
        ...
        if (rc.onTheMap(l40) && !m40.isWall() && !m40.hasRuin() && (maxT || !basic8.Map.isNearRuin(l40))){ // (0,0)
        ...
        if (rc.onTheMap(l41) && !m41.isWall() && !m41.hasRuin() && (maxT || !basic8.Map.isNearRuin(l41))){ // (0,1)
        ...
        if (rc.onTheMap(l49) && !m49.isWall() && !m49.hasRuin() && (maxT || !basic8.Map.isNearRuin(l49))){ // (1,0)
        ...
        if (rc.onTheMap(l50) && !m50.isWall() && !m50.hasRuin() && (maxT || !basic8.Map.isNearRuin(l50))){ // (1,1)
        ...
        if (rc.onTheMap(l42) && !m42.isWall() && !m42.hasRuin() && (maxT || !basic8.Map.isNearRuin(l42))){ // (0,2)
        ...
        if (rc.onTheMap(l58) && !m58.isWall() && !m58.hasRuin() && (maxT || !basic8.Map.isNearRuin(l58))){ // (2,0)
        ...
        if (rc.onTheMap(l51) && !m51.isWall() && !m51.hasRuin() && (maxT || !basic8.Map.isNearRuin(l51))){ // (1,2)
        ...
        if (rc.onTheMap(l59) && !m59.isWall() && !m59.hasRuin() && (maxT || !basic8.Map.isNearRuin(l59))){ // (2,1)
        ...
        if (rc.onTheMap(l60) && !m60.isWall() && !m60.hasRuin() && (maxT || !basic8.Map.isNearRuin(l60))){ // (2,2)
        ...
        if (rc.onTheMap(l43) && !m43.isWall() && !m43.hasRuin() && (maxT || !basic8.Map.isNearRuin(l43))){ // (0,3)
        ...
        if (rc.onTheMap(l67) && !m67.isWall() && !m67.hasRuin() && (maxT || !basic8.Map.isNearRuin(l67))){ // (3,0)
        ...
        if (rc.onTheMap(l52) && !m52.isWall() && !m52.hasRuin() && (maxT || !basic8.Map.isNearRuin(l52))){ // (1,3)
            PaintType p = m52.getPaint();
            if (p.isEnemy() || p != PaintType.ALLY_SECONDARY){
                if (ans == null) ans = l52;
            }
        }
        if (rc.onTheMap(l68) && !m68.isWall() && !m68.hasRuin() && (maxT || !basic8.Map.isNearRuin(l68))){ // (3,1)
            PaintType p = m68.getPaint();
            if (p.isEnemy() || p != PaintType.ALLY_SECONDARY){
                if (ans == null) ans = l68;
            }
        }
        if (rc.onTheMap(l61) && !m61.isWall() && !m61.hasRuin() && (maxT || !basic8.Map.isNearRuin(l61))){ // (2,3)
            PaintType p = m61.getPaint();
            if (p.isEnemy() || p != PaintType.ALLY_PRIMARY){
                if (ans == null) ans = l61;
            }
        }
        if (rc.onTheMap(l69) && !m69.isWall() && !m69.hasRuin() && (maxT || !basic8.Map.isNearRuin(l69))){ // (3,2)
            PaintType p = m69.getPaint();
            if (p.isEnemy() || p != PaintType.ALLY_PRIMARY){
                if (ans == null) ans = l69;
            }
        }
        if (rc.onTheMap(l44) && !m44.isWall() && !m44.hasRuin() && (maxT || !basic8.Map.isNearRuin(l44))){ // (0,4)
            PaintType p = m44.getPaint();
            if (p.isEnemy() || p != PaintType.ALLY_SECONDARY){
                if (ans == null) ans = l44;
            }
        }
        if (rc.onTheMap(l76) && !m76.isWall() && !m76.hasRuin() && (maxT || !basic8.Map.isNearRuin(l76))){ // (4,0)
            PaintType p = m76.getPaint();
            if (p.isEnemy() || p != PaintType.ALLY_SECONDARY){
                if (ans == null) ans = l76;
            }
        }
        if (rc.onTheMap(l53) && !m53.isWall() && !m53.hasRuin() && (maxT || !basic8.Map.isNearRuin(l53))){ // (1,4)
            PaintType p = m53.getPaint();
            if (p.isEnemy() || p != PaintType.ALLY_PRIMARY){
                if (ans == null) ans = l53;
            }
        }
        if (rc.onTheMap(l77) && !m77.isWall() && !m77.hasRuin() && (maxT || !basic8.Map.isNearRuin(l77))){ // (4,1)
            PaintType p = m77.getPaint();
            if (p.isEnemy() || p != PaintType.ALLY_PRIMARY){
                if (ans == null) ans = l77;
            }
        }
        if (rc.onTheMap(l70) && !m70.isWall() && !m70.hasRuin() && (maxT || !basic8.Map.isNearRuin(l70))){ // (3,3)
            PaintType p = m70.getPaint();
            if (p.isEnemy() || p != PaintType.ALLY_SECONDARY){
                if (ans == null) ans = l70;
            }
        }
        if (rc.onTheMap(l62) && !m62.isWall() && !m62.hasRuin() && (maxT || !basic8.Map.isNearRuin(l62))){ // (2,4)
            PaintType p = m62.getPaint();
            if (p.isEnemy() || p != PaintType.ALLY_SECONDARY){
                if (ans == null) ans = l62;
            }
        }
        if (rc.onTheMap(l78) && !m78.isWall() && !m78.hasRuin() && (maxT || !basic8.Map.isNearRuin(l78))){ // (4,2)
            PaintType p = m78.getPaint();
            if (p.isEnemy() || p != PaintType.ALLY_SECONDARY){
                if (ans == null) ans = l78;
            }
        }
        if (rc.onTheMap(l31) && !m31.isWall() && !m31.hasRuin() && (maxT || !basic8.Map.isNearRuin(l31))){ // (-1,0)
        ...
        if (rc.onTheMap(l39) && !m39.isWall() && !m39.hasRuin() && (maxT || !basic8.Map.isNearRuin(l39))){ // (0,-1)
        ...
        if (rc.onTheMap(l30) && !m30.isWall() && !m30.hasRuin() && (maxT || !basic8.Map.isNearRuin(l30))){ // (-1,-1)
        ...
        if (rc.onTheMap(l32) && !m32.isWall() && !m32.hasRuin() && (maxT || !basic8.Map.isNearRuin(l32))){ // (-1,1)
        ...
        if (rc.onTheMap(l48) && !m48.isWall() && !m48.hasRuin() && (maxT || !basic8.Map.isNearRuin(l48))){ // (1,-1)
        ...
        if (rc.onTheMap(l22) && !m22.isWall() && !m22.hasRuin() && (maxT || !basic8.Map.isNearRuin(l22))){ // (-2,0)
        ...
        if (rc.onTheMap(l38) && !m38.isWall() && !m38.hasRuin() && (maxT || !basic8.Map.isNearRuin(l38))){ // (0,-2)
        ...
        if (rc.onTheMap(l21) && !m21.isWall() && !m21.hasRuin() && (maxT || !basic8.Map.isNearRuin(l21))){ // (-2,-1)
        ...
        if (rc.onTheMap(l23) && !m23.isWall() && !m23.hasRuin() && (maxT || !basic8.Map.isNearRuin(l23))){ // (-2,1)
        ...
        if (rc.onTheMap(l29) && !m29.isWall() && !m29.hasRuin() && (maxT || !basic8.Map.isNearRuin(l29))){ // (-1,-2)
        ...
        if (rc.onTheMap(l33) && !m33.isWall() && !m33.hasRuin() && (maxT || !basic8.Map.isNearRuin(l33))){ // (-1,2)
        ...
        if (rc.onTheMap(l47) && !m47.isWall() && !m47.hasRuin() && (maxT || !basic8.Map.isNearRuin(l47))){ // (1,-2)
        ...
        if (rc.onTheMap(l57) && !m57.isWall() && !m57.hasRuin() && (maxT || !basic8.Map.isNearRuin(l57))){ // (2,-1)
        ...
        if (rc.onTheMap(l20) && !m20.isWall() && !m20.hasRuin() && (maxT || !basic8.Map.isNearRuin(l20))){ // (-2,-2)
        ...
        if (rc.onTheMap(l24) && !m24.isWall() && !m24.hasRuin() && (maxT || !basic8.Map.isNearRuin(l24))){ // (-2,2)
        ...
        if (rc.onTheMap(l56) && !m56.isWall() && !m56.hasRuin() && (maxT || !basic8.Map.isNearRuin(l56))){ // (2,-2)
        ...
        if (rc.onTheMap(l13) && !m13.isWall() && !m13.hasRuin() && (maxT || !basic8.Map.isNearRuin(l13))){ // (-3,0)
        ...
        if (rc.onTheMap(l37) && !m37.isWall() && !m37.hasRuin() && (maxT || !basic8.Map.isNearRuin(l37))){ // (0,-3)
        ...
        if (rc.onTheMap(l12) && !m12.isWall() && !m12.hasRuin() && (maxT || !basic8.Map.isNearRuin(l12))){ // (-3,-1)
        ...
        if (rc.onTheMap(l14) && !m14.isWall() && !m14.hasRuin() && (maxT || !basic8.Map.isNearRuin(l14))){ // (-3,1)
        ...
        if (rc.onTheMap(l28) && !m28.isWall() && !m28.hasRuin() && (maxT || !basic8.Map.isNearRuin(l28))){ // (-1,-3)
        ...
        if (rc.onTheMap(l34) && !m34.isWall() && !m34.hasRuin() && (maxT || !basic8.Map.isNearRuin(l34))){ // (-1,3)
        ...
        if (rc.onTheMap(l46) && !m46.isWall() && !m46.hasRuin() && (maxT || !basic8.Map.isNearRuin(l46))){ // (1,-3)
        ...
        if (rc.onTheMap(l66) && !m66.isWall() && !m66.hasRuin() && (maxT || !basic8.Map.isNearRuin(l66))){ // (3,-1)
        ...
        if (rc.onTheMap(l11) && !m11.isWall() && !m11.hasRuin() && (maxT || !basic8.Map.isNearRuin(l11))){ // (-3,-2)
        ...
        if (rc.onTheMap(l15) && !m15.isWall() && !m15.hasRuin() && (maxT || !basic8.Map.isNearRuin(l15))){ // (-3,2)
        ...
        if (rc.onTheMap(l19) && !m19.isWall() && !m19.hasRuin() && (maxT || !basic8.Map.isNearRuin(l19))){ // (-2,-3)
        ...
        if (rc.onTheMap(l25) && !m25.isWall() && !m25.hasRuin() && (maxT || !basic8.Map.isNearRuin(l25))){ // (-2,3)
        ...
        if (rc.onTheMap(l55) && !m55.isWall() && !m55.hasRuin() && (maxT || !basic8.Map.isNearRuin(l55))){ // (2,-3)
        ...
        if (rc.onTheMap(l65) && !m65.isWall() && !m65.hasRuin() && (maxT || !basic8.Map.isNearRuin(l65))){ // (3,-2)
        ...
        if (rc.onTheMap(l4) && !m4.isWall() && !m4.hasRuin() && (maxT || !basic8.Map.isNearRuin(l4))){ // (-4,0)
        ...
        if (rc.onTheMap(l36) && !m36.isWall() && !m36.hasRuin() && (maxT || !basic8.Map.isNearRuin(l36))){ // (0,-4)
        ...
        if (rc.onTheMap(l3) && !m3.isWall() && !m3.hasRuin() && (maxT || !basic8.Map.isNearRuin(l3))){ // (-4,-1)
        ...
        if (rc.onTheMap(l5) && !m5.isWall() && !m5.hasRuin() && (maxT || !basic8.Map.isNearRuin(l5))){ // (-4,1)
        ...
        if (rc.onTheMap(l27) && !m27.isWall() && !m27.hasRuin() && (maxT || !basic8.Map.isNearRuin(l27))){ // (-1,-4)
        ...
        if (rc.onTheMap(l35) && !m35.isWall() && !m35.hasRuin() && (maxT || !basic8.Map.isNearRuin(l35))){ // (-1,4)
        ...
        if (rc.onTheMap(l45) && !m45.isWall() && !m45.hasRuin() && (maxT || !basic8.Map.isNearRuin(l45))){ // (1,-4)
        ...
        if (rc.onTheMap(l75) && !m75.isWall() && !m75.hasRuin() && (maxT || !basic8.Map.isNearRuin(l75))){ // (4,-1)
        ...
        if (rc.onTheMap(l10) && !m10.isWall() && !m10.hasRuin() && (maxT || !basic8.Map.isNearRuin(l10))){ // (-3,-3)
        ...
        if (rc.onTheMap(l16) && !m16.isWall() && !m16.hasRuin() && (maxT || !basic8.Map.isNearRuin(l16))){ // (-3,3)
        ...
        if (rc.onTheMap(l64) && !m64.isWall() && !m64.hasRuin() && (maxT || !basic8.Map.isNearRuin(l64))){ // (3,-3)
        ...
        if (rc.onTheMap(l2) && !m2.isWall() && !m2.hasRuin() && (maxT || !basic8.Map.isNearRuin(l2))){ // (-4,-2)
        ...
        if (rc.onTheMap(l6) && !m6.isWall() && !m6.hasRuin() && (maxT || !basic8.Map.isNearRuin(l6))){ // (-4,2)
        ...
        if (rc.onTheMap(l18) && !m18.isWall() && !m18.hasRuin() && (maxT || !basic8.Map.isNearRuin(l18))){ // (-2,-4)
        ...
        if (rc.onTheMap(l26) && !m26.isWall() && !m26.hasRuin() && (maxT || !basic8.Map.isNearRuin(l26))){ // (-2,4)
        ...
        if (rc.onTheMap(l54) && !m54.isWall() && !m54.hasRuin() && (maxT || !basic8.Map.isNearRuin(l54))){ // (2,-4)
        ...
        if (rc.onTheMap(l74) && !m74.isWall() && !m74.hasRuin() && (maxT || !basic8.Map.isNearRuin(l74))){ // (4,-2)
